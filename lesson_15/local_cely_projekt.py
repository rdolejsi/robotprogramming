...
class Robot:
    ...
    # def reaguj_na_krizovatku(self):
    #     if prikazy[self.__index_prikazu] == Konstanty.VZAD:
    #         self.couvni()
    #         self.__index_prikazu += 1
    #     else:
    #         self.popojed()
    #         if prikazy[self.__index_prikazu] == Konstanty.ROVNE:
    #             self.__index_prikazu += 1
    #             return
    #         elif prikazy[self.__index_prikazu] == Konstanty.VPRAVO:
    #             self.__index_prikazu += 1
    #             self.zatoc(-0.5)
    #             return
