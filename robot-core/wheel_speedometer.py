...
class WheelSpeedometer:
    ...
    def __init__(self):
        ...
        self.tick_counter_history_length_max = 10
    ...
    def on_tick(self):
        ...
        if self.tick_last_time == 0 or time_delta >= self.tick_counter_history_interval_ms * 10:
            ...
            if time_delta >= self.tick_counter_history_interval_ms:
                ...
                if len(self.tick_counter_history) > self.tick_counter_history_length_max:
    ...
    def get_speed_cm_per_sec(self):
        ...
        if len(self.tick_counter_history) > 0:
            ...
            speed /= len(self.tick_counter_history) * self.tick_counter_history_interval_ms / 1000
        return speed
